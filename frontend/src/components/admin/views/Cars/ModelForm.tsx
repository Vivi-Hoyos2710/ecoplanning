...
export const ModelForm = ({ handleOpen, open, brandId, brandName }: ModelForm) => {
    const { register, handleSubmit,reset,formState: { errors } } = useForm<ModelInfo>();
                ...
                <Card className="mx-auto w-full max-w-[24rem]">
                    ...
                    <CardBody className="flex flex-col gap-6 items-end">
                        ...
                        <form className="w-full" onSubmit={handleSubmit(submitBrandForm)}>
                            <Input type="text" label="Model name" size="lg" {...register('name', {
                            ...
                            {dataError !== '' && <Typography variant="small" color="red">{dataError}</Typography>}
