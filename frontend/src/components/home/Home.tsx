        ...
        <div
          ...
          >
            ...
            <div className=" flex flex-col items-center justify-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-[90%]">
              ...
              >
                Say goodbye to distance anxiety and embrace a new era of stress-free electric driving with ecoplanning
              </Typography>
              <Typography size="sm"  color="gray"
                className= " text-lg text-center mb-2 text-base md:text-sm lg:text-md xl:text-xl"
              >
                You can travel and at the same time conserve your vehicle&apos;s electric battery, save costs and help the planet.
              </Typography>
