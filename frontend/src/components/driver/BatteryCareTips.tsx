  ...
  const data = [
    {
      ...
      image:
        'https://www.mundodeportivo.com/urbantecno/hero/2022/04/que-se-necesita-para-cargar-coche-electrico-casa.jpg?width=1200&aspect_ratio=16:9'
    },
    {
      label: 'Temperature',
      value: 'react',
                  ...
                  {data.map(({ value, icon, icon1, tittle, desc, desc1, desc2, image }) => (
                    <TabPanel key={value} value={value}>
                      <div className="flex items-center">
                        <Card
                          shadow={true}
                          className="shadow-lg rounded-tl rounded-br p-1 border border-gray-300  border-2"
                        >
                          {React.createElement(icon, { className: 'w-8 h-8' })}
                        </Card>
                        <Typography className="font-bold text-center mt-3 ml-2">
                          {tittle}
                        </Typography>
                      </div>
                      <div className="mt-5">
